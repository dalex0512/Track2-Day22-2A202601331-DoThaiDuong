...
# Guardrails 0.10 mặc định bật async validation và telemetry. Demo này chỉ cần
# local/synchronous validation, giúp chạy ổn định cả trên Python 3.14 và CI.
...
# Demo chạy hoàn toàn local; không gửi telemetry ra ngoài.
...
def main():
    ...
    for demo, filename in [
        (demo_pii_guard, "04_pii_demo_log.txt"),
        ...
        print(output, end="")
        (evidence_dir / filename).write_text(output, encoding="utf-8")

    print(f"\n💾 Đã lưu demo logs vào {evidence_dir}")
